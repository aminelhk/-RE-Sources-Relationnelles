...
import commentsOnResourcesRoutes from "./routes/commentsOnResourcesRoutes";
...
app.use("/api/commentsOnResources", commentsOnResourcesRoutes); // Route pour les commentaires (des ressources)
