...
INSERT INTO "new_Resource" ("authorId", "categoryResourceId", "content", "idResource", "isArchived", "isExploited", "isFavorite", "isValidated", "title", "typeResourceId") SELECT "authorId", "categoryResourceId", "content", "idResource", "isArchived", "isExploited", "isFavorite", "isValidated", "title", "typeResourceId" FROM "Resource";
DROP TABLE "Resource";
